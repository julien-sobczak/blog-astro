...
In addition, I write to practice my English (I'm French). I will not get better at writing in English by reviewing my flashcards. [Directness](/read/2020/2020-05-07-ultralearning) means learning in an environment close to how you intend to use the skill. If I want to write fluently in English, I have to write in English. Period.
