...
tags: ['learning']
unofficialTags: []
recommendations: ['2018-11-16-why-i-read-books']
---
...
I love [reading]({% post_url write/2018-11-16-why-i-read-books %}). But reading is not necessarily the best approach to learn, especially when developing skills like programming. I learn best by doing, and writing is a great way to put knowledge into practice.
...
I also write to challenge my opinions. Trying to find the right words often forced me to reconsider my position on a subject. Writing allows me to step back and observe the situation with different eyes to spot incoherences in my reasoning. [Common sense rarely makes sense]({% post_url write/2021-03-24-common-sense-doesnt-make-sense %}), and writing helps me find better answers.
...
Since I cannot write about what I don't understand, I have a [category on my blog]({{ site.url }}/categories/inspect.html) to close this gap. Using UTF-8 to write my code does not mean I understand Unicode. Writing such articles is not trivial, but the satisfaction of completing them is even greater. Mastery makes me love my job even more.
...
In addition, I write to practice my English (I'm French). I will not get better at writing in English by reviewing my flashcards. [Directness]({% post_url read/2020/2020-05-07-ultralearning %}) means learning in an environment close to how you intend to use the skill. If I want to write fluently in English, I have to write in English. Period.
