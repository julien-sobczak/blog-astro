...
subject: "Ebooks"
description: >
  Books and e-readers have advantages and inconvenients. Instead of designing a winner, let discuss why both are still relevant.
tags: [reading]
topics: [books]
relatedWritePosts:
...
>
> -- <cite>Stephen Fry, English comedian, actor, writer, presenter, and activist</cite>
...
<Admonition type="note" className="None" title="Tablets are not a-readers!">
...
<Admonition type="note" className="None" title="Paperback or Hardcover?">
...
<Admonition type="note" className="None" title="What about Speed Reading?">
...
**E-readers was not designed with speed reading in mind**. Previewing chapters is hard, if not impossible with current e-readers. You can’t flip through the pages quickly to have a glimpse at what is awaiting you in the next pages. Amazon, with its [**Word Runner**](https://www.amazon.com/gp/help/customer/display.html?nodeId=201852380), helps you read while minimizing eye movements, but this represents only an insufficient and anecdotal part of the solution.
...
[^5]: http://www.pnas.org/content/112/4/1232.full.pdf
