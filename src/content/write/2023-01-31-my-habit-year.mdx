...
Reading books is a lovely activity for introverts ^(Focusing&nbsp;alone)^. I've always read books, mostly fiction and comics when I was a kid, and now mostly nonfiction books. [Nothing influences me more than books](/write/2021-05-19-why-i-write). The best books challenge my opinions ^(Think&nbsp;differently)^, provide so many ideas ^(Being&nbsp;creative)^ that I try to share ^(Challenging&nbsp;others)^. Reading is learning by definition ^(In-depth&nbsp;learning)^.
