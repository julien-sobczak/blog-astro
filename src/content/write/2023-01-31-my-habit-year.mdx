...
tags: ['productivity']
unofficialTags: []
recommendations: ['2023-01-31-my-lego-habit-tracker']
---
...
Reading books is a lovely activity for introverts ^(Focusing&nbsp;alone)^. I've always read books, mostly fiction and comics when I was a kid, and now mostly nonfiction books. [Nothing influences me more than books]({% post_url write/2021-05-19-why-i-write %}). The best books challenge my opinions ^(Think&nbsp;differently)^, provide so many ideas ^(Being&nbsp;creative)^ that I try to share ^(Challenging&nbsp;others)^. Reading is learning by definition ^(In-depth&nbsp;learning)^.

{/* Take notes (using a Second Brain) */}

<img src="habit-take-notes.svg" />
{/* [facilitates] Writing */}
...
<img src="habit-write-blogposts.svg" />
{/* [practices] Writing */}
...
<img src="habits-and-activities.svg" />
...
If you are interested in learning more about the story and the logic behind this map, I devoted a companion [blog post]({% post_url write/2023-01-31-my-lego-habit-tracker %}) on this topic to share my recommendations.
