---
slug: "2020/02/23/simplicity-is-not-simple"
...
subject: "Simplicity"
description: >
  Make it simple is probably the most useless advice in practice. 
tags: [thinking]
...
<Admonition type="caution" className="license">
  This post is a part of a two-parts series. This first post focuses on simplicity while [the following one](/write/2020/06/02/complexity-is-not-complex) focuses on complexity.
</Admonition>

> The purpose of software engineering is to control complexity, not to create it.
>
> -- <cite>Jon L. Bentley, Programming Pearls</cite>
...
<Admonition type="note" className="None" title="A look inside our brain">
...
<img src="/posts_resources/2020-02-23-simplicity-is-not-simple/abstractions-step-1-2.png" width="600" class="center" />
...
<img src="/posts_resources/2020-02-23-simplicity-is-not-simple/abstractions-step-3.png" width="300" class="center" />
...
<img src="/posts_resources/2020-02-23-simplicity-is-not-simple/abstractions-step-4.png" width="375" class="center" />
...
<Admonition type="note" className="None" title="Abstractions are everywhere">
...
<Admonition type="tip">
✔️ Simplicity for you can mean complexity for others. Don’t optimize locally. **Think globally**.
</Admonition>
