---
slug: "2021/03/24/common-sense-doesnt-make-sense"
title: "Common Sense Does Not Make Sense"
author: "Julien Sobczak"
date: 2021-03-24
subject: "Common Sense"
description: >
  It's uncommon to question our common sense but ignoring our common sense makes sense.
tags: ['understanding']
...
>
> -- <cite>Nicholas Amhurst, "political writer, The Secret History of the University of Oxford, 1726</cite>
...
<Lead>
This slogan has become ubiquitous not just among organic food. The company for which I work uses the slogan “The Cloud that Makes Sense.” And younger employees -- the so-called millennials -- are the first generation to value a strong sense of purpose over anything else.[ˆ1]
</Lead>
...
* `2 tablespoons` of hard-earned **knowledge**. <br/>
...
* `2` GPS coordinates of your **location**. <br/>
...
* `1 teaspoon` finely sorted **priorities**. <br/>
...
* `1 tablespoon` of life **purpose**. <br/>
...
<img src="/posts_resources/2021-03-24-common-sense-doesnt-make-sense/recipe.png" width="350" />
...
<img src="/posts_resources/2021-03-24-common-sense-doesnt-make-sense/uncommon.png" width="400" />

We must therefore learn to consider common sense as _our un_common sense. Cannibalism still makes sense in some cultures or in different times and places. It's not a problem as long as you plan your next vacation wisely.
...
We have already elaborated that we cannot trust our common sense. We don't think the way we think we think.[^4] We are not rational creatures, even if we think we are. The seminal book _Thinking, Fast and Slow_ condenses in more than 400 pages the most surprising experiments about our irrationality. **We can't use common sense to make rational decisions.**
...
<Admonition type="note" className="None" title="Running using common sense">
...
* **Running slower makes you run faster**. Most training sessions must be run at low intensity. Champions broke all records not by running at a higher intensity, but by running at a lower intensity and running more.[^7]
* **Running using proper form is not important**. Forcing a different posture is less efficient than simply trying to run naturally.[^8]
* **Running with low-cost and old shoes is preferable to lower the risk of injuries**. In fact, running barefoot can be even more profitable since cushioned shoes prevent our feet from behaving naturally.[^9]
* **Stretching must not be done after a race or even after a simple training session**. You will not recover faster by putting pressure on a muscle that has been aggressed.[^10]
</Admonition>


In the end, **common sense makes sense until you have thought critically about it**, in which case, common sense stops making sense. Learning is the antidote. Here is a better definition of common sense that I have found [online](https://www.quora.com/What-exactly-is-common-sense):
...
* Don't say, “It's common sense.” It’s a polite way to say “My opinion, stupid.”[^11]
...
[^4]: I found this sentence in the same excellent book _Everything Is Obvious_. I really recommend this book to challenge your common sense about common sense.
...
[^6]: Jim Taylor Ph.D., Common Sense Is Neither Common nor Sense,
...
[^9]: No other book had such an impact in the running world as _Born To Run_ written by Christopher McDougall, https://www.amazon.com/Born-Run-Hidden-Superathletes-Greatest/dp/0307279189/
