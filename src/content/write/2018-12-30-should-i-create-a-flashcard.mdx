---
slug: "2018/12/30/should-i-create-a-flashcard"
...
export function Yes() {
  return <img src="/posts_resources/2018-12-30-should-i-create-a-flashcard/yes.png" className="inline" height="20" />
}
export function No() {
  return <img src="/posts_resources/2018-12-30-should-i-create-a-flashcard/no.png" className="inline" height="20" />
}
...
<a href="/posts_resources/2018-12-30-should-i-create-a-flashcard/quiz.svg"><img src="/posts_resources/2018-12-30-should-i-create-a-flashcard/quiz.png" width="700" /></a>
...
* _You could be more productive if_ you stay focus for a longer period. For example, knowing the solution from memory will avoid you interruptions. No need to search on Google. You can stay in the zone.[^1]
...
[^1]: In positive psychology, flow, also known colloquially as being in the zone, is the mental state of operation in which a person performing an activity is fully immersed in a feeling of energized focus, full involvement, and enjoyment in the process of the activity.
