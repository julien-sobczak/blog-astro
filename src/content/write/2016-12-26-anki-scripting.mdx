...
<Admonition type="tip" className="None" title="apkg, anki2, what are these file extensions?">
...
<img src="sqlitebrowser-anki2-collection.png" width="750" />
...
<img src="deck-configuration.png" />
...
<img src="anki-new_reversed_card.png" />
...
<img src="anki-study.png" />

<img src="anki-study_card.png" />
...
<dl className="markers">
  ...
  <dt><Marker number={3} /></dt>
  <dd>Label syntax such as <code>{{t+|fr|clavier|m}}</code> is used exhaustively inside the wiki text. Most of the content is present inside these labels but the syntax is not easily parseable.</dd>
...
```java title="ApiController" {'1':18} {'2':22}
@RestController
@RequestMapping("/api")
public class ApiController {
