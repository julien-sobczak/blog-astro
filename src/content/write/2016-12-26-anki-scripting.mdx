...
<dl className="markers">
  ...
  <dt><Marker number={3} /></dt>
  <dd>Label syntax such as {% raw %}{{t+|fr|clavier|m}}{% endraw %} is used exhaustively inside the wiki text. Most of the content is present inside these labels but the syntax is not easily parseable.</dd>
