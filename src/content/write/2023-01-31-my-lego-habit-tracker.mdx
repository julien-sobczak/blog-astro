---
slug: "2023/01/31/my-lego-habit-tracker"
title: "My LEGO Habit Tracker"
author: "Julien Sobczak"
date: 2023-01-31
subject: "Habit Tracker"
description: My project to use LEGO tiles to track my habits.
...
>
> -- <cite>John C. Maxwell, American Author, Pastor</cite>
...
I came across the idea of using LEGO to track my habit after viewing the [LEGO World Map](https://www.lego.com/en-us/product/world-map-31203) set:

<img src="/posts_resources/2023-01-31-lego-habit-tracker/lego-world-map-content.webp" />


As always, my idea was not really new. There are so many LEGO fans in the world. For example, you can [assemble a minifig](https://unbrickedfig.com/blog/2018/11/21/lego-habit-tracker-a-fun-way-to-visualize-developing-habits/) for each habit and stack plates or bricks to represent progress (one habit completed = one plate/tile/stud/brick).


<img src="/posts_resources/2023-01-31-lego-habit-tracker/lego-original-habit-tracker.png" />
...
[LEGO Art](https://en.wikipedia.org/wiki/Lego_Art) sets were introduced in 2020 to create iconic characters or artwork in a mosaic-like format using LEGO 1x1 studs. The [LEGO World Map](https://www.lego.com/en-fr/product/world-map-31203) with its 11695 pieces is still the largest LEGO set at the time of writing and is the one I decided to use for my LEGO habit tracker.

<img src="/posts_resources/2023-01-31-lego-habit-tracker/lego-world-map-box.webp" />
...
* **Milestones**: The motivation is to represent completed tasks. Milestones are a call for action, a motivation to complete tasks (instead of leaving tasks unfinished for too long). The only requirement is for the results to be visible or concrete. For example, I used one of these tiles after publishing a new article on my blog, a new feature on a side project, or after building my LEGO Box (see <a href="#faq">F.A.Q.</a>).
...
<img src="/posts_resources/2023-01-31-lego-habit-tracker/lego-habit-example.png" />
...
{/*.footnote:[My only parenting habit is to read a few books on the subject every year in addition to the incredible [newsletter Daily Dad](https://dailydad.com/). Kids grew up so fast. We don't have time to plan how to spend time. We just do it.] It's not something that must feel challenging.*/}
...
I decided instead to design a small box in LEGO to keep a subset of the stock of tiles at hand (see [my LEGO box](#bonus_my_lego_box).
...
>
> -- <cite>Tiago Forte, Building a Second brain</cite>
...
The [World Map](https://www.lego.com/fr-fr/product/world-map-31203) is not the only set. The LEGO Art catalog grows over time and now offers different options:

* [Mickey Mouse](https://www.lego.com/fr-fr/product/disney-s-mickey-mouse-31202): 2658 tiles, 4 main colors.
* [Batman](https://www.lego.com/product/jim-lee-batman-collection-31205): 4167 tiles, 3 main colors in the Batman configuration. (💡 Different pictures are possible and two sets can be combined to create larger artworks.)
* The [Great Wave](https://www.lego.com/product/hokusai-the-great-wave-31208): 1810 tiles, 3 main colors on the background (⚠️ Not only 1x1 tiles on the foreground).
* The [Mosaic Maker](https://www.lego.com/product/mosaic-maker-40179): 4702 tiles, 5 colors, customizable picture.
...
<img src="/posts_resources/2023-01-31-lego-habit-tracker/panda.png" />
{/* source: https://commons.wikimedia.org/wiki/File:Ailuropoda_melanoleuca_in_captivity_(4204834074).jpg */}


1. **Open the file** in Photoshop

  <img src="/posts_resources/2023-01-31-lego-habit-tracker/photoshop-step1.png" />
...
2. **Crop**
  ...
  <img src="/posts_resources/2023-01-31-lego-habit-tracker/photoshop-step2.png" />
...
3. **Resize** using `Image` > `Image Size...`
  ...
  <img src="/posts_resources/2023-01-31-lego-habit-tracker/photoshop-step3.png" />


4. **Reduce the number of colors** using `Image` > `Mode` > `Inverted Colors...` (click "OK" if asked to flatten layers and try `Pattern` for the dither mode)

  _Objective_: Match the number of habits you plan to track.

  <img src="/posts_resources/2023-01-31-lego-habit-tracker/photoshop-step4.png" />
  ...
  <img src="/posts_resources/2023-01-31-lego-habit-tracker/photoshop-step4-result.png" />

5. **Recolor** using `Image` > `Mode` > `Color Table...`

  _Objective_: Use similar colors as the ones available on the LEGO store.

  <img src="/posts_resources/2023-01-31-lego-habit-tracker/photoshop-step5.png" />

6. **Count** the colors

  _Objective_: Determine to number of tiles to order.

  <img src="/posts_resources/2023-01-31-lego-habit-tracker/panda-out.png" width="300" height="300" />
  ...
  <img src="/posts_resources/2023-01-31-lego-habit-tracker/panda-colors.png" />

The last step is to order the tiles on a marketplace like [BrickLink](https://www.bricklink.com/) (💰 75 x 75 = ~$60). Don't forget to also add the pieces for the frame. (Check the required bricks on the [spare parts page](https://www.lego.com/en-us/pick-and-build/pick-a-brick?query=&page=1&filters.i0.key=variants.attributes.appearsIn&filters.i0.ranges.i0.from=%2231203%3A%22&filters.i0.ranges.i0.to=%2231203%3A9999%22&sku=31203) or in the [notice](https://www.lego.com/en-us/service/buildinginstructions/31203) of the Lego World Map for inspiration.)


## <a name="bonus_my_lego_box"></a>Bonus: My Lego Box
...
I used the official set [Jewelry Box](https://www.lego.com/fr-fr/product/jewelry-box-41915) as inspiration (see the [instructions](https://www.lego.com/cdn/product-assets/product.bi.core.pdf/6327567.pdf)) and decided to create a box with 9 sorting compartments. I used the application [_My Studio_ by BrickLink](https://www.bricklink.com/v2/build/studio.page) (other applications exist) to simply place an order on BrickLink with just a click. Here is the [result](/posts_resources/2023-01-31-lego-habit-tracker/my-lego-box.io):

<img src="/posts_resources/2023-01-31-lego-habit-tracker/my-lego-box-top.png" width="500" />
<img src="/posts_resources/2023-01-31-lego-habit-tracker/my-lego-box-inside.png" width="300" />
