...
In short, theory is abstracted practice, and practice is applied theory. **A theory cannot exist without practice**.footnote:[The inverse is not necessarily true. Many things happen in practice for which no theory exists to explain them--for example the [placebo effect](https://en.wikipedia.org/wiki/Placebo#Effects).]

<img src="theory-and-practice.png" />
