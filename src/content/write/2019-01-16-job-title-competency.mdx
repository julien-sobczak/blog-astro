---
slug: "2019/01/16/job-title-competency"
title: "Why a Job Title Will Never Make You Competent?"
author: "Julien Sobczak"
date: 2019-01-16
subject: "Job Title"
description: >
  These last years, we have seen a proliferation of new job titles to describe the same, unchanged activity -- making lines of code come alive. What can we learn from a job title? Should we care about it? Should we move to another position?
tags: [mastering]
topics: [career]
---
...
>
> -- <cite>Neil deGrasse Tyson, American astrophysicist</cite>
...
Based on social networks, Kent Beck, Martin Fowler, Andy Hunt are _programmers_, Mitchell Hashimoto is a _developer_, James Gosling, Rod Pike are _software engineers_, and Bob Martin is a _software craftsman_. Their job titles are short and not very specific, and could be reduced even more, since they are all listed on Wikipedia under the [list of famous programmers](https://en.wikipedia.org/wiki/List_of_programmers).
...
[^1]: https://peakthebook.com/index.html
