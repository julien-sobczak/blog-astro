...
tags: ['management']
unofficialTags: []
recommendations: ['2020-02-23-simplicity-is-not-simple']
---
...
This post is a follow-up of [a previous post]({% post_url write/2020-02-23-simplicity-is-not-simple %}) on simplicity where I discussed why not everything has to be simple. In this new post, I use the opposite argument to explain why everything doesn’t have to be complex.
</Admonition>
...
In [my previous post]({% post_url write/2020-02-23-simplicity-is-not-simple %}), I detailed the main differences between a complicated problem and a complex problem. In short, if you can divide a system to inspect each part in isolation, you have a complicated problem. If interactions play a bigger role in understanding the system, you have a complex system where the whole is greater than the sum of its parts. 
...
<img src="platform-teams-structure.png" />
...
<a href="("'/posts_resources/2020-06-02-complexity-is-not-complex/platform-teams-interactions-solution1.png'",)"><img src="platform-teams-interactions-solution1.png" /></a>
...
<a href="("'/posts_resources/2020-06-02-complexity-is-not-complex/platform-teams-interactions-solution2.png'",)"><img src="platform-teams-interactions-solution2.png" /></a>
