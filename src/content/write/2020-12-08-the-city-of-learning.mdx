---
slug: "2020/12/08/the-city-of-learning"
...
This post is part of a series. Each post uses a different metaphor to illustrate a specific aspect of the learning process. You can check the following posts [The Landscape of Knowledge](/write/2020-12-08-the-landscape-of-knowledge) and [The Pyramid of Expertise](/write/2020-12-08-the-pyramid-of-expertise).
</Admonition>

> “Travel is like an endless university. You never stop learning.”
>
> -- <cite> Harvey Lloyd, American photographer</cite>
...
<img src="/posts_resources/2020-12-08-the-city-of-learning/map-x2.png" />
...
<img src="/posts_resources/2020-12-08-the-city-of-learning/map-single-path-x2.png" />
...
<img src="/posts_resources/2020-12-08-the-city-of-learning/map-diversity-x2.png" />
_We have a team with a lot of diverse experiences, but too few common grounds to create a jelled team._
{nbsp} +

<img src="/posts_resources/2020-12-08-the-city-of-learning/map-diversity-inclusive-x2.png" />
...
<Admonition type="note" className="None" title="Trainings">
...
<img src="/posts_resources/2020-12-08-the-city-of-learning/map-single-path.png" />
...
<Admonition type="note" className="None" title="My struggle with Computer Networks">
Concerning my difficulties about learning networks, I decided to rethink my approach. My previous expositions on the subject all used the same [bottom-up approach](https://www.goodreads.com/book/show/166190.Computer_Networks), starting with the lower layers. Therefore:

* I decided to move in the opposite direction, starting with application protocols like HTTP, before [moving down the TCP/IP model](https://www.goodreads.com/book/show/13661492-computer-networking).
* I read several similar books even if they covered the same materials. Sometimes, a little repetition is necessary.
* I looked [under the hood of the TCP/IP stack](https://www.goodreads.com/book/show/583307.The_Implementation) in Linux to face the reality that networking is just code running on servers, and as a developer, there is no reason I can’t make sense of it.
...
<img src="/posts_resources/2020-12-08-the-city-of-learning/map-two-paths-x2.png" />
...
<img src="/posts_resources/2020-12-08-the-city-of-learning/map-teleportation-x2.png" />
...
<img src="/posts_resources/2020-12-08-the-city-of-learning/map-dash-shaped-x2.png" />
...
<img src="/posts_resources/2020-12-08-the-city-of-learning/map-project-x2.png" />

### The I-Shaped Developer (the “Expert”)

The _I-shaped_ developer is a specialist with a well-defined area of expertise.

<img src="/posts_resources/2020-12-08-the-city-of-learning/map-i-shaped-x2.png" />
...
The [_T-shaped_](https://en.wikipedia.org/wiki/T-shaped_skills) developer represents the classic agile team member, which explains why he is often the ideal hire for a company. The T-shaped developer has a specialty (e.g., Go Backend Developer), and in addition, has a wide breadth of experience with other skills (e.g., technical writing, UX Design, DevOps practices, …).

<img src="/posts_resources/2020-12-08-the-city-of-learning/map-t-shaped-x2.png" />
...
In the [next article of this series](/write/2020-12-08-the-landscape-of-knowledge), we will escape the city to discover the wonders of the world. We will discuss how to expand our knowledge and our ignorance in new directions at the same time. Fasten your seat belt and get ready for a wild ride.


[^1]: https://www.ted.com/talks/rocio_lorenzo_how_diversity_makes_teams_more_innovative
