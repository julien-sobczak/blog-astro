...
description: >
  A flat organizational chart has obvious advantages but also non-obvious disadvantages, especially when ignoring the proper communication patterns required for decision-making.
tags: [leading]
topics: [management]
relatedWritePosts:
...
<img src="/posts_resources/2021-02-15-your-organizational-chart-lies/parenting-analogy.png" title="What happens when decision conflicts are settled by upper management." width="500" />
