...
```
* <Marker number={1} /> We listen to events triggered by the runner.
* <Marker number={2} /> We memorize every test execution.
* <Marker number={3} /> We save every failure.
...
```
* <Marker number={1} /> We use a utility class to find the test methods to execute.
* <Marker number={2} /> We notify about the progression after every step.
* <Marker number={3} /> We create a new instance of our test class before every test method execution (see explanations below).
