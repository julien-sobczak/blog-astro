...
```java title="java/lang/String.java" showLineMarkers:{'1': [701], '2': [707], '3': [714]}
...
```java title="java/lang/String.java" showLineMarkers:{'1': [739], '2': [748], '3': [755], '4': [760]}
public final class String
    implements java.io.Serializable, Comparable<String>, CharSequence,
...
```java showLineMarkers:{'1': [803], '2': [814]}
...
```python title="Tools/unicode/makeunicodedata.py" showLineMarkers:{'1': [1200], '2': [1203]}
...
```java title="src/java.base/share/classes/java/lang/CharacterData.java" showLineMarkers:{'1': [1296]}
package java.lang;
...
```go title="src/strings/strings.go" showLineMarkers:{'1': [1420], '2': [1436], '3': [1442]}
...
```go title="src/unicode/tables.go" showLineMarkers:{'1': [1491], '2': [1492]}
...
```go title="src/unicode/letter.go" showLineMarkers:{'1': [1506], '2': [1513, 1533], '3': [1531]}
