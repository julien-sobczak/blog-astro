...
```html showLineMarkers:{'1': [21], '2': [25]}
<!doctype html>
<html>
  <head>
...
```
* <Marker number={1} /> The only dependency is this stylesheet
* <Marker number={2} /> Add the tag `<i>` to use any icon and customize it using CSS classes
...
<img src="css-content-property.png" />
...
>
> -- <cite>Modzilla Developer Network,@font-face</cite>
...
<img src="use-font-FontAwesome.png" />
