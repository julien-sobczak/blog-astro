...
This post is a shorter version of my previous post [Unicode for Curious Developers Loving Code 😉]({% post_url inspect/2021-06-19-unicode-for-curious-developers %}). My motivation is to persuade you that you must learn more about Unicode and that you should read my other post 😀.
</Admonition>
...
```
* <Marker number={1} /> We replaced the ASCII-only class `\w` with the Unicode-compatible class `\p{L}`.
