...
description: Understand what happens when your program executes a system call.
tags: [programming]
topics: [linux]
excerpt: >
...
```c title="benchmark.c" {'1':6} {'2':18} {'2':25} {'3':26}
#include <stdio.h>
#include <sys/types.h>
#include <unistd.h>
#include <time.h>
...
```c title="/sysdeps/unix/sysv/linux/getpid.c" {'1':29} {'2':31} {'3':33}
#include <unistd.h>
#include <tls.h>
#include <sysdep.h>
...
```txt title="arch/x86/entry/syscalls/syscall_64.tbl"
#
...
<Admonition type="note" className="None" title="<code>int 0x80 vs syscall</code>">
...
```c title="arch/x86/kernel/cpu/common.c" {'1':3} {'2':4}
...
```c title="arch/x86/entry/syscall_64.c" {'1':2} {'2':3}
...
```c title="arch/x86/entry/common.c" {'1':5} {'2':6} {'3':7}
...
```txt title="src/runtime/sys_linux_arm64.s"
...
```c title="src/java.base/unix/native/libjava/ProcessHandleImpl_unix.c" {'1':17}
#include "jni.h"
#include "jni_util.h"
